...
<tr>
	<th colspan=2 align=left>1. Subject :</th>
		    ...
		    <%
                    ...
                    ResultSet s=st.executeQuery("select subid,subname from course,dept where course.did=dept.did and course.did='"+dno+"'");
                    %>
                 <tr>
                    <td>Subject Name:</td>
...
<br><br>
<h4>2.This Subject is interesting. Do you agree?<br><br></h4>
<table border="0" cellspacing="0" cellpadding=Excellent0>
<tr>
...
<br><br>
<h4>3.Do you want to change this subject?</h4><br><br>
<table border="0" cellspacing="0" cellpadding=Excellent0>
<tr>
...
<br><br>
<h4>4.Is this relevant?<br><br></h4>
<table border="0" cellspacing="0" cellpadding=Excellent0>
<tr>
