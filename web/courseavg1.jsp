...
<html>
    ...
    <body>
        ...
        <%int current=1;
            ...
            String query=("select course.did,course.subid,course.subname,cast(avg(intrst)as decimal(10,2) )as AvgIntrst,cast(avg(chnge)as decimal(10,2)) as AvgChnge,cast(avg(relevant) as decimal(10,2)) as AvgRelevant  from teacher,subject,course where course.subname='" + subname + "'") ; 
...
if(rs.next()==true){
  ...
  <h1 align="center">View Average Feedback</h1>
        ...
        <table border="2" align="center">
            ...
            <tr>
                <td>Dept Id</td>
                <td><input type="text" name="did" value="<%=rs.getString("did")%>"></td>
            </tr>
           ...
           <tr>
            ...
            <br><br><a href="teacherhome.jsp"<%=tid%> >Back To Home Page</a><br><br>
            </center>
</form>
</body>
</html>